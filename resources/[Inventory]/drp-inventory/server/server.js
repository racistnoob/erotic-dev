...
function GenerateInformation(player, itemid, itemdata) {
    ...
    return new Promise((resolve, reject) => {
        ...
        if (itemid == "policebadge") {
            exports["core"].CreateBadge(player.substring(4), function (BadgeInfo) {
        ...
        if (itemid == "emsbadge") {
            exports["drp-scripts"].CreateBadge(player.substring(4), function (SentInfo) {
                returnInfo = JSON.stringify({
        ...
        if (itemid.includes("mzinsurance_")) {
            exports["drp-scripts"].CreateInsurance(player.substring(4), function (SentInfo) {
                returnInfo = JSON.stringify({
                    cid: SentInfo['cid'],
        ...
        if (itemid == "policebadge") {
            ...
            switch (itemid.toLowerCase()) {
                case "idcard":
                    ...
                    return resolve(returnInfo);
                case "policebadge":
                    exports["drp-police"].CreateBadge(player.substring(4), function (BadgeInfo) {
                        returnInfo = JSON.stringify({
                            callsign: BadgeInfo['callsign'],
                            firstname: BadgeInfo['firstname'],
                            lastname: BadgeInfo['lastname'],
