WeaponComponents = {
    ["WEAPON_HEAVYRIFLE"] = {
        ...
        extmag = "COMPONENT_HEAVYRIFLE_CLIP_02"
    },
    ["WEAPON_ASSAULTRIFLE"] = {
        scope = "COMPONENT_AT_SCOPE_MACRO",
        silencer = "COMPONENT_AT_AR_SUPP_02",
        flashlight = "COMPONENT_AT_AR_FLSH",
        drummag = "COMPONENT_ASSAULTRIFLE_CLIP_03",
        extmag = "COMPONENT_ASSAULTRIFLE_CLIP_02",
    },
    ["WEAPON_TACTICALRIFLE"] = {
        silencer = "COMPONENT_AT_AR_SUPP_02",
        grip = "COMPONENT_AT_AR_AFGRIP",
        flashlight = "COMPONENT_AT_AR_FLSH_REH",
        extmag = "COMPONENT_TACTICALRIFLE_CLIP_02"
    },
    ["WEAPON_HEAVYPISTOL"] = {
    ...
    ["WEAPON_CARBINERIFLE_MK2"] = {
        ...
        scope2 = "COMPONENT_AT_SCOPE_MEDIUM_MK2",
        scope3 = "COMPONENT_AT_SCOPE_MACRO_MK2",
    ...
    ["WEAPON_SPECIALCARBINE_MK2"] = {
        ...
        scope2 = "COMPONENT_AT_SCOPE_MACRO_MK2",
        scope3 = "COMPONENT_AT_SIGHTS",
        grip = "COMPONENT_AT_AR_AFGRIP_02",
        extmag = "COMPONENT_SPECIALCARBINE_MK2_CLIP_02",
    },
    ...
    ["WEAPON_HEAVYSNIPER_MK2"] = {
        silencer = "COMPONENT_AT_SR_SUPP_03",
    },
}