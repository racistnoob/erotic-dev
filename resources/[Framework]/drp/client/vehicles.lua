...
AddEventHandler('echorp:getvehicledata', function(vehicle, cb)
    ...
    if DoesEntityExist(vehicle) then
        ...
        VehicleData['fuelLevel'] = exports["drp-fuel"]:GetFuel(vehicle)
...
AddEventHandler('echorp:SetVehicleData', function(vehicle, VehicleData, forceFuel, cb)
    ...
    if DoesEntityExist(vehicle) then
        --if GetEntityModel(vehicle) == VehicleData['model'] then 
            ...
            if type(forceFuel) == 'boolean' then if VehicleData['fuelLevel'] then exports["drp-fuel"]:SetFuel(vehicle, VehicleData['fuelLevel']) end
            else exports["drp-fuel"]:SetFuel(vehicle, forceFuel) end
