...
AddEventHandler("explosionEvent", function(sender, ev)
    ...
    if explosionCounts[playerId][explosionType].count > maxExplosions then
            ...
            embeds = {
                {
                    ...
                    description = "Exceeded explosion limit for type: **"..explosionType.."**\nCreated at: **"..ev.posX..", "..ev.posY..", "..ev.posZ.."**",
                }
            }
        },
        2500,
        function(error)
            if error then
                ...
                "Exceeded explosion limit for type: **"..explosionType.."**\nCreated at: **"..ev.posX..", "..ev.posY..", "..ev.posZ.."**"
            )
            return
        end
    end
    ...
    return  
        ...
        if not allowedExplosions[tonumber(explosionType)] then
            ...
            sendToDiscord("Explosion by: ".. GetPlayerName(sender), "Explosion Type: **"..explosionType.."**\nCreated at: **"..ev.posX..", "..ev.posY..", "..ev.posZ.."**")
        end
    end
end)
