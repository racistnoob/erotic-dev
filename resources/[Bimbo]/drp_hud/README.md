...
<h1 align="center">FiveM React and Lua Boildrplate</h1>

<div align="center">
A simple and extendable React (TypeScript) boildrplate designed around the Lua ScRT
</div>
...
![David](https://img.shields.io/david/project-error/fivem-react-boildrplate-lua)
[![Dependabot Status](https://api.dependabot.com/badges/status?host=github&repo=project-error/fivem-react-boildrplate-lua)](https://dependabot.com)
</div>

This repository is a basic boildrplate for getting started
...
This version of the boildrplate is meant for the CfxLua runtime.
...
*The boildrplate was made using `yarn` but is still compatible with
`npm`.*
...
This boildrplate comes with some utilities and examples to work off of.
...
This boildrplate was designed with development workflow in mind.
