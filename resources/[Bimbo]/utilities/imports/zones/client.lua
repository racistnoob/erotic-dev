...
local function debugPoly(self)
    ...
    for i = 1, #self.polygon do
        ...
        DrawLine(a.x, a.y, a.z, b.x, b.y, b.z, self.debugColour.r,  self.debugColour.g,  self.debugColour.b,  100)
        DrawLine(a.x, a.y, a.z, c.x, c.y, c.z, self.debugColour.r,  self.debugColour.g,  self.debugColour.b,  100)
        DrawLine(b.x, b.y, b.z, d.x, d.y, d.z, self.debugColour.r,  self.debugColour.g,  self.debugColour.b,  100)
...
local function setDebug(self, bool, colour)
    ...
    self.debugColour = bool and vec4(colour?.r or self.debugColour?.r or 255, colour?.g or self.debugColour?.g or 0, colour?.b or self.debugColour?.b or 0, colour?.a or self.debugColour?.a or 100) or nil
