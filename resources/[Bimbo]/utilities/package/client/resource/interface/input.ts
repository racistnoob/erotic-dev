...
export const inputDialog: inputDialog = async (heading, rows) => await exports.utilities.inputDialog(heading, rows);

export const closeInputDialog = () => exports.utilities.inputDialog();
